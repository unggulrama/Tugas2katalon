...
WebUI.setText(findTestObject('Object Repository/Page_My Account/text_input__reg_email'), 'unggulrama@gmail')
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_My Account/text_ul_Error Please provide a valid email address'), 
    0)
